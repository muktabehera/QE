...
* TC-43135 - Audiences POST:

  Verify that user is able to create Audience with parameters (id, Name, Client, Network location, Delivery System) using request POST /audiences.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43135')
    @pytest.mark.Audiences
    @pytest.mark.POST
    def test_TC_43135_POST_Audiences_Name_Client_Networklocation_Delivery_System(self, context):
        """TC-43135 - Audiences-POST
           Verify that user is able to create Audience with parameters (id, Name, Client, Network location, Delivery System) using request POST /audiences."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create Audience with parameters (id, Name, Client, Network location, Delivery System) using request POST /audiences."""):
