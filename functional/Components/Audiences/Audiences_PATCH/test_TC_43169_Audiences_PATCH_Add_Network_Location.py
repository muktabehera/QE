...
* TC-43169 - Audiences PATCH:

  Verify that user is able to update (Add Network Locations) Audience using PATCH "audiences/{id}".
...
JSON data sent to PathFinder in this test:
  ...
  {'clients': [{'id': 'clientsWithAllDetails'}],
   ...
   'name': 'PATCH_audience_AddNetworkLoc',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43169')
    @pytest.mark.Audiences
    @pytest.mark.PATCH
    def test_TC_43169_PATCH_Audiences_Add_Network_Location(self, context):
        """TC-43169 - Audiences-PATCH
           Verify that user is able to update (Add Network Locations) Audience using PATCH "audiences/{id}"."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to update (Add Network Locations) Audience using PATCH "audiences/{id}"."""):
