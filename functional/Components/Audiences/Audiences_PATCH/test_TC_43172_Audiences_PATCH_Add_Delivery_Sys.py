...
* TC-43172 - Audiences PATCH:

  Verify that user is able to update (Add Delivery System) Audience using PATCH "audiences/{id}".
...
JSON data sent to PathFinder in this test:
  ...
  {'clients': [{'id': 'clientsWithAllDetails'}],
   ...
   'name': 'PATCH_audience_addDeliverySys',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43172')
    @pytest.mark.Audiences
    @pytest.mark.PATCH
    def test_TC_43172_PATCH_Audiences_Add_Delivery_Sys(self, context):
        """TC-43172 - Audiences-PATCH
           Verify that user is able to update (Add Delivery System) Audience using PATCH "audiences/{id}"."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to update (Add Delivery System) Audience using PATCH "audiences/{id}"."""):
