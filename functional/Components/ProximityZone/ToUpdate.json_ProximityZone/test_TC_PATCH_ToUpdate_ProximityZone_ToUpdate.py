...
"""PFE Component Tests - ToUpdate.json.

* TC-PATCH - ToUpdate.json ProximityZone:
...
@pytest.allure.story('ToUpdate')
@pytest.allure.feature('ProximityZone')
class Test_PFE_Components(object):
    """PFE ToUpdate.json test cases."""

    @pytest.allure.link('https://jira.qumu.com/browse/TC-PATCH')
    @pytest.mark.ToUpdate
    @pytest.mark.ProximityZone
    def test_TC_PATCH_ProximityZone_ToUpdate(self, context):
        """TC-PATCH - ToUpdate.json-ProximityZone - """
        # Define a test step
        with pytest.allure.step('.'):
            ...
            # ProximityZone the ToUpdate.json.
            ...
            # ProximityZone the ToUpdate.json, and check we got the error we expect
            try:
