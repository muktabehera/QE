...
{'configAdminCanEdit': False,
 'configurations': [],
 'id': 'ProximityPostMultipleRanges',
 'name': 'ProximityPostMultipleRanges',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43826')
    @pytest.mark.ProximityZone
    @pytest.mark.POST
    def test_TC_43826_POST_ProximityZone_Multiple_Ranges(self, context):
        """TC-43826 - ProximityZone-POST - Multiple Ranges"""
        # Define a test step
        with pytest.allure.step('Multiple Ranges.'):
