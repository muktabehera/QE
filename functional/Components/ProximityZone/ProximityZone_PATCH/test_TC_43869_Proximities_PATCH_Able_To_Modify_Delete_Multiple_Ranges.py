...
* TC-43869 - Proximity_Zones PATCH:

  Verify that user is able to Modify [Delete Multiple Ranges] in Proximity Zone using request PATCH /proximities{id} ".
...
JSON data sent to PathFinder in this test:
  ...
  {'configAdminCanEdit': False,
   ...
   'name': 'ProximityUpdatedDeleteRanges',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43869')
    @pytest.mark.Proximity_Zones
    @pytest.mark.PATCH
    def test_TC_43869_PATCH_Proximity_Zones_Able_To_Modify_Delete_Multiple_Ranges(self, context):
        """TC-43869 - Proximity_Zones-PATCH
           Verify that user is able to Modify [Delete Multiple Ranges] in Proximity Zone using request PATCH /proximities{id} "."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to Modify [Delete Multiple Ranges] in Proximity Zone using request PATCH /proximities{id} "."""):
