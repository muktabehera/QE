...
* TC-45622 - Audience_Match POST:

  Verify that user with Match permission is unable to fetch list of Matching Audiences/Clients/Network Locations using Post method.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-45622')
    @pytest.mark.Audience_Match
    @pytest.mark.POST
    def test_TC_45622_POST_Audience_Match_Audience_Match_Post(self, context):
        """TC-45622 - Audience_Match-POST
           Verify that user with Match permission is unable to fetch list of Matching Audiences/Clients/Network Locations using Post method."""
        # Define a test step
        with pytest.allure.step("""Verify that user with Match permission is unable to fetch list of Matching Audiences/Clients/Network Locations using Post method."""):
