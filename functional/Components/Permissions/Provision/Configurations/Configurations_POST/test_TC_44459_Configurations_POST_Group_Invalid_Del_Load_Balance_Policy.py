...
Equivalent test CURL command:
  ...
  curl -k -H "Host: <client_host>" -H "Authorization: Bearer
       ...
       application/json" "<PF_host>://<client_host>/configurations"
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_44459_POST_Configurations_Group_Invalid_Del_Load_Balance_Policy(self, context):
        """TC-44459 - Configurations-POST
           Verify that user is unable to create group on providing invalid values in parameter 'deliveryLoadBalancePolicy' using request POST '/groups'."""
        # Define a test step
