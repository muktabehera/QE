...
* TC-44492 - Broadcasts POST:

    Verify that user is able to create broadcast with same Name and unique ID using request POST "/broadcasts".
...
JSON data sent to PathFinder in this test:
  ...
  {'id': 'Broadcast_StandaloneVNE_HLSUnique',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44492')
    @pytest.mark.Broadcasts
    @pytest.mark.POST
    def test_TC_44492_POST_Broadcasts_Able_To_Create_Broadcast_With_Same_Name_Unique_Id(self, context):
        """TC-44492 - Broadcasts-POST
             Verify that user is able to create broadcast with same Name and unique ID using request POST "/broadcasts"."""
        # Define a test step
        with pytest.allure.step("""  Verify that user is able to create broadcast with same Name and unique ID using request POST "/broadcasts"."""):
