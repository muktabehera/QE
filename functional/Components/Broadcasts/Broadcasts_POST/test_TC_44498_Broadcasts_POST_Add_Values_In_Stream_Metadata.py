...
* TC-44498 - Broadcasts POST:

  Verify that user is able to add values in streamMetaData using request POST "/broadcasts".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44498')
    @pytest.mark.Broadcasts
    @pytest.mark.POST
    def test_TC_44498_POST_Broadcasts_Add_Values_In_Stream_Metadata(self, context):
        """TC-44498 - Broadcasts-POST
           Verify that user is able to add values in streamMetaData using request POST "/broadcasts"."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to add values in streamMetaData using request POST "/broadcasts"."""):
