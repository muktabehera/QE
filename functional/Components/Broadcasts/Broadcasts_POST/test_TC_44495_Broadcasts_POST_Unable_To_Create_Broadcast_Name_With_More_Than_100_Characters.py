...
JSON data sent to PathFinder in this test:
  ...
  {'id': 'broadcastNamewith100Character',
   'name': 'yJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJkZWZhdWx0Iiwic3ViIjoiYWRtaW5AMTcyLjMwLjIuMTQ5OjgwODAuY29tIiwiYXVkIjoicWVkOmRlZm',
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_44495_POST_Broadcasts_Unable_To_Create_Broadcast_Name_With_More_Than_100_Characters(self, context):
        """TC-44495 - Broadcasts-POST
           Verify that user is unable to create broadcast name with more than 100 characters using request POST "/broadcasts"."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create broadcast name with more than 100 characters using request POST "/broadcasts"."""):
            ...
            broadcastCreate = context.sc.BroadcastCreate(
                id='broadcastNamewith100Character',
                name=
                'yJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJkZWZhdWx0Iiwic3ViIjoiYWRtaW5AMTcyLjMwLjIuMTQ5OjgwODAuY29tIiwiYXVkIjoicWVkOmRlZm',
