...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_44485_POST_Broadcasts_Broadcasts_Able_To_Create_And_Play_Rtsp_With_Standalone_Vne(self, context):
        """TC-44485 - Broadcasts-POST
           Verify that user is able to create and play RTSP stream with Standalone VNE in live program using request POST "/broadcasts"."""
        # Define a test step
