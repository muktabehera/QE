...
JSON data sent to PathFinder in this test:
  ...
  {'id': 'broadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vne',
   'name': 'Broadcast ID 100 Character',
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_44494_POST_Broadcasts_Unable_To_Create_Broadcast_Id_With_More_Than_10_Characters(self, context):
        """TC-44494 - Broadcasts-POST
           Verify that user is unable to create broadcast ID with more than 100 characters using request POST "/broadcasts"."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create broadcast ID with more than 100 characters using request POST "/broadcasts"."""):
            ...
            broadcastCreate = context.sc.BroadcastCreate(
                id=
                'broadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vnebroadcast-vne',
                name='Broadcast ID 100 Character',
