...
* TC-44488 - Broadcasts POST:

  Verify that user is able to create and play HLS stream with VNE standalone in live program using request POST "/broadcasts".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44488')
    @pytest.mark.Broadcasts
    @pytest.mark.POST
    def test_TC_44488_POST_Broadcasts_Able_To_Create_And_Play_Hls_With_Vne_Standalone(self, context):
        """TC-44488 - Broadcasts-POST
           Verify that user is able to create and play HLS stream with VNE standalone in live program using request POST "/broadcasts"."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create and play HLS stream with VNE standalone in live program using request POST "/broadcasts"."""):
