...
JSON data sent to PathFinder in this test:
  ...
  {'id': 'Broadcast_VidoenetVNE_HLS',
   'name': 'Broadcast_VidoenetVNE_HLS',
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_44487_POST_Broadcasts_Broadcasts_Able_To_Create_And_Play_Hls_With_Videonet_Origin_Edge(self, context):
        """TC-44487 - Broadcasts-POST
           Verify that user is able to create and play HLS stream with VideoNet(origin-Edge) in live program using request POST "/broadcasts"."""
        # Define a test step
