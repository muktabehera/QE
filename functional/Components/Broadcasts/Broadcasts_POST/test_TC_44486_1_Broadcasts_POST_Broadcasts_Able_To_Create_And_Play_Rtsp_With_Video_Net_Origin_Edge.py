...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_44486_POST_Broadcasts_Broadcasts_Able_To_Create_And_Play_Rtsp_With_Video_Net_Origin_Edge(self, context):
        """TC-44486 - Broadcasts-POST
           Verify that user is able to create and play RTSP stream with VideoNet(origin-Edge) in live program using request POST "/broadcasts"."""
        # Define a test step
