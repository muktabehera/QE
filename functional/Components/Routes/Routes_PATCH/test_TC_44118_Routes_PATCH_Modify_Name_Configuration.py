...
* TC-44118 - Routes PATCH:

  Verify that user is able to modify route name and configurations using request PATCH "/routes".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44118')
    @pytest.mark.Routes
    @pytest.mark.PATCH
    def test_TC_44118_PATCH_Routes_Modify_Name_Configuration(self, context):
        """TC-44118 - Routes-PATCH
           Verify that user is able to modify route name and configurations using request PATCH "/routes"."""
        # Define a test step
        ...
        # Define a test step
        with pytest.allure.step("""Then verify that user is able to modify route name and configurations using request PATCH "/routes"."""):
