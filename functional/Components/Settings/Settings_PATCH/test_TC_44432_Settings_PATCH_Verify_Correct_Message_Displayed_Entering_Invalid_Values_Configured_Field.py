...
* TC-44432 - Settings PATCH:

  Verify correct message is displayed on entering invalid values ( 1234,abcd,!@#) in 'configured' field using request PATCH /settings.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44432')
    @pytest.mark.Settings
    @pytest.mark.PATCH
    def test_TC_44432_PATCH_Settings_Verify_Correct_Message_Displayed_Entering_Invalid_Values_Configured_Field(self, context):
        """TC-44432 - Settings-PATCH
           Verify correct message is displayed on entering invalid values ( 1234,abcd,!@#) in 'configured' field using request PATCH /settings."""
