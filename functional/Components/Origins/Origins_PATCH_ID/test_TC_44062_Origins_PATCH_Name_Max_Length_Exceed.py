...
* TC-44062 - Origins PATCH:

  Verify that user is unable to modify origin on providing length greater than 100 character in parameter 'Name' using request PATCH '/origins'.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44062')
    @pytest.mark.Origins
    @pytest.mark.PATCH
    def test_TC_44062_PATCH_Origins_Name_Max_Length_Exceed(self, context):
        """TC-44062 - Origins-PATCH
           Verify that user is unable to modify origin on providing length greater than 100 character in parameter 'Name' using request PATCH '/origins'."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to modify origin on providing length greater than 100 character in parameter 'Name' using request PATCH '/origins'."""):
