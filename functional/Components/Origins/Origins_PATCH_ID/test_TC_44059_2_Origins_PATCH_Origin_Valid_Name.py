...
* TC-44059 - Origins PATCH:

  Verify that user is able to modify origin with valid values for parameters 'Name' using request PATCH /origins.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44059')
    @pytest.mark.Origins
    @pytest.mark.PATCH
    def test_TC_44059_PATCH_Origins_Origin_Valid_Name(self, context):
        """TC-44059 - Origins-PATCH
           Verify that user is able to modify origin with valid values for parameters 'Name' using request PATCH /origins."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to modify origin with valid values for parameters 'Name' using request PATCH /origins."""):
