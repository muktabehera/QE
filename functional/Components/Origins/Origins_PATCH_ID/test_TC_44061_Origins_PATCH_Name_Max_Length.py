...
* TC-44061 - Origins PATCH:

  Verify that user is able to modify origin on providing max length of 100 character in parameter 'Name' using request PATCH '/origins'.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44061')
    @pytest.mark.Origins
    @pytest.mark.PATCH
    def test_TC_44061_PATCH_Origins_Name_Max_Length(self, context):
        """TC-44061 - Origins-PATCH
           Verify that user is able to modify origin on providing max length of 100 character in parameter 'Name' using request PATCH '/origins'."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to modify origin on providing max length of 100 character in parameter 'Name' using request PATCH '/origins'."""):
