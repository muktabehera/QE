...
* TC-43652 - Network_Locations PATCH:

  Verify that user is able to modify network location with rule and group having parameter 'Request Header>Matches Regex' using request PATCH '/networkLocations/'.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43652')
    @pytest.mark.Network_Locations
    @pytest.mark.PATCH
    def test_TC_43652_PATCH_Network_Locations_Network_Locations_Request_Header_Regex(self, context):
        """TC-43652 - Network_Locations-PATCH
           Verify that user is able to modify network location with rule and group having parameter 'Request Header>Matches Regex' using request PATCH '/networkLocations/'."""
        # Define a test step
        with pytest.allure.step("""Test1: Verify that user is able to modify network location with rule and group having parameter 'Request Header>Matches Regex' using request PATCH '/networkLocations/'."""):
        ...
        # Define a test step
        with pytest.allure.step("""Test2: Verify that user is able to modify network location with rule and group having parameter 'Request Header>Matches Regex' using request PATCH '/networkLocations/'."""):
