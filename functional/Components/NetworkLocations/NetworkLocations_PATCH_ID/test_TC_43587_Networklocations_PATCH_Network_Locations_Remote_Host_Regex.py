...
* TC-43587 - Network_Locations PATCH:

  Verify that user is able to create modify network location with rule and group having parameter 'Remote Host>Matches Regex' using request PATCH '/networkLocations'.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43587')
    @pytest.mark.Network_Locations
    @pytest.mark.PATCH
    def test_TC_43587_PATCH_Network_Locations_Network_Locations_Remote_Host_Regex(self, context):
        """TC-43587 - Network_Locations-PATCH
           Verify that user is able to create modify network location with rule and group having parameter 'Remote Host>Matches Regex' using request PATCH '/networkLocations'."""
        # Define a test step
        with pytest.allure.step("""Test1: Verify that user is able to create modify network location with rule and group having parameter 'Remote Host>Matches Regex' using request PATCH '/networkLocations'."""):
        ...
        # Define a test step
        with pytest.allure.step("""Test2: Verify that user is able to create modify network location with rule and group having parameter 'Remote Host>Matches Regex' using request PATCH '/networkLocations'."""):
