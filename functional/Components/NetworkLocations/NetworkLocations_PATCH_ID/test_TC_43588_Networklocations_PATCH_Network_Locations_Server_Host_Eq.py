...
* TC-43588 - Network_Locations PATCH:

  Verify that user is able to modify network location with rule and group having parameter 'Server Host>Equals' using request PATCH '/networkLocations'.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43588')
    @pytest.mark.Network_Locations
    @pytest.mark.PATCH
    def test_TC_43588_PATCH_Network_Locations_Network_Locations_Server_Host_Eq(self, context):
        """TC-43588 - Network_Locations-PATCH
           Verify that user is able to modify network location with rule and group having parameter 'Server Host>Equals' using request PATCH '/networkLocations'."""
        # Define a test step
        with pytest.allure.step("""Test1: Verify that user is able to modify network location with rule and group having parameter 'Server Host>Equals' using request PATCH '/networkLocations'."""):
        ...
        # Define a test step
        with pytest.allure.step("""Test2: Verify that user is able to modify network location with rule and group having parameter 'Server Host>Equals' using request PATCH '/networkLocations'."""):
