...
* TC-43585 - Network_Locations PATCH:

  Verify that user is able to modify network location with rule and group having parameter 'Remote Address>Matches Proximity Zone' using request PATCH '/networkLocations'.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43585')
    @pytest.mark.Network_Locations
    @pytest.mark.PATCH
    def test_TC_43585_PATCH_Network_Locations_Remote_Address_Proximity(self, context):
        """TC-43585 - Network_Locations-PATCH
           Verify that user is able to modify network location with rule and group having parameter 'Remote Address>Matches Proximity Zone' using request PATCH '/networkLocations'."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to modify network location with rule and group having parameter 'Remote Address>Matches Proximity Zone' using request PATCH '/networkLocations'."""):
