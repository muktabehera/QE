...
* TC-43654 - Network_Locations PATCH:

  Verify that user is able to modify network location with rule and group having parameter 'Request Query Parameter>Matches Regex' using request PATCH '/networkLocations/'.
   ...
   'matchingRule': {'groups': [{'groups': [],
                                ...
                                'rules': [{'contextField': 'remoteAddress',
                                          ...
                                          {'contextField': 'queryParamMap',
                                           'contextFieldKey': 'queryParamMapEQ',
                                           'contextFieldType': 'String',
                                           'expressionType': 'Map',
                                           'matchValue': 'queryParamMapEQ',
                                           'operator': 'EQ'},
                                          {'contextField': 'queryParamMap',
                                           'contextFieldKey': '101441',
                                           'contextFieldType': 'String',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43654')
    @pytest.mark.Network_Locations
    @pytest.mark.PATCH
    def test_TC_43654_PATCH_Network_Locations_Network_Locations_Request_Query_Regex(self, context):
        """TC-43654 - Network_Locations-PATCH
           Verify that user is able to modify network location with rule and group having parameter 'Request Query Parameter>Matches Regex' using request PATCH '/networkLocations/'."""
        # Define a test step
        with pytest.allure.step("""Test1: Verify that user is able to modify network location with rule and group having parameter 'Request Query Parameter>Matches Regex' using request PATCH '/networkLocations/'."""):
        ...
        # Define a test step
        with pytest.allure.step("""Test2: Verify that user is able to modify network location with rule and group having parameter 'Request Query Parameter>Matches Regex' using request PATCH '/networkLocations/'."""):
