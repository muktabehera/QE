...
* TC-43590 - Network_Locations PATCH:

  Verify that user is able to modify network location with rule and group having parameter 'Server Port>Equals' using request PATCH 'networkLocations'.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43590')
    @pytest.mark.Network_Locations
    @pytest.mark.PATCH
    def test_TC_43590_PATCH_Network_Locations_Server_Port_Eq(self, context):
        """TC-43590 - Network_Locations-PATCH
           Verify that user is able to modify network location with rule and group having parameter 'Server Port>Equals' using request PATCH 'networkLocations'."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to modify network location with rule and group having parameter 'Server Port>Equals' using request PATCH 'networkLocations'."""):
