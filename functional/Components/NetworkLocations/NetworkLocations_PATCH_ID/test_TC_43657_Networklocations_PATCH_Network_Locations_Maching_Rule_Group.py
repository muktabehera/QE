...
* TC-43657 - Network_Locations PATCH:

  Verify that user is able to modify child group with parameter 'matchingRule['ALL', 'ANY', 'NONE']' using request POST '/networkLocations'.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43657')
    @pytest.mark.Network_Locations
    @pytest.mark.PATCH
    def test_TC_43657_PATCH_Network_Locations_Network_Locations_Maching_Rule_Group(self, context):
        """TC-43657 - Network_Locations-PATCH
           Verify that user is able to modify child group with parameter 'matchingRule['ALL', 'ANY', 'NONE']' using request POST '/networkLocations'."""
        # Define a test step
        with pytest.allure.step("""Test1: Verify that user is able to modify child group with parameter 'matchingRule['ALL', 'ANY', 'NONE']' using request POST '/networkLocations'."""):
        ...
        # Define a test step
        with pytest.allure.step("""Test2: Verify that user is able to modify child group with parameter 'matchingRule['ALL', 'ANY', 'NONE']' using request POST '/networkLocations'."""):
