...
* TC-43367 - Authorization_Systems POST:

  Verify that user is able to generate Token by providing same macKey as of Authorization using request POST /authorizationSystems/{id}/generateToken  ".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43367')
    @pytest.mark.Authorization_Systems
    @pytest.mark.POST
    def test_TC_43367_POST_Authorization_Systems_Same_Mackey(self, context):
        """TC-43367 - Authorization_Systems-POST
           Verify that user is able to generate Token by providing same macKey as of Authorization using request POST /authorizationSystems/{id}/generateToken  "."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to generate Token by providing same macKey as of Authorization using request POST /authorizationSystems/{id}/generateToken  "."""):
