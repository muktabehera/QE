...
* TC-43369 - Authorization_Systems POST:

  Verify that user is unable to generate Token while 'Subject' field is empty using request POST /authorizationSystems/{id}/generateToken  ".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43369')
    @pytest.mark.Authorization_Systems
    @pytest.mark.POST
    def test_TC_43369_POST_Authorization_Systems_Empty_Subjectfield(self, context):
        """TC-43369 - Authorization_Systems-POST
           Verify that user is unable to generate Token while 'Subject' field is empty using request POST /authorizationSystems/{id}/generateToken  "."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to generate Token while 'Subject' field is empty using request POST /authorizationSystems/{id}/generateToken  "."""):
