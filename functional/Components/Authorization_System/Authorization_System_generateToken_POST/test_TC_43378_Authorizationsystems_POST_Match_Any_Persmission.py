...
* TC-43378 - Authorization_Systems POST:

  Verify that user is able to generate Token with permission [Match Any] while same is selected in the Authorization system using request POST /authorizationSystems/{id}/generateToken  ".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43378')
    @pytest.mark.Authorization_Systems
    @pytest.mark.POST
    def test_TC_43378_POST_Authorization_Systems_Match_Any_Persmission(self, context):
        """TC-43378 - Authorization_Systems-POST
           Verify that user is able to generate Token with permission [Match Any] while same is selected in the Authorization system using request POST /authorizationSystems/{id}/generateToken  "."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to generate Token with permission [Match Any] while same is selected in the Authorization system using request POST /authorizationSystems/{id}/generateToken  "."""):
