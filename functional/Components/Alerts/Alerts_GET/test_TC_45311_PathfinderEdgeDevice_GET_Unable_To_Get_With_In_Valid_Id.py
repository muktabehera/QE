...
* TC-45311 - Pathfinder_Edge_Device GET:

  Verify User is unable to GET the alerts by passing an invalid ID using request GET /devices/veDevices/{id}/alerts .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-45311')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.GET
    def test_TC_45311_GET_Pathfinder_Edge_Device_Unable_To_Get_With_In_Valid_Id(self, context):
        """TC-45311 - Pathfinder_Edge_Device-GET
           Verify User is unable to GET the alerts by passing an invalid ID using request GET /devices/veDevices/{id}/alerts ."""
        # Define a test step
        with pytest.allure.step("""Verify User is unable to GET the alerts by passing an invalid ID using request GET /devices/veDevices/{id}/alerts ."""):
