  ...
  {'activationDate': '2017-09-04T07:36:46.542Z',
   ...
   'files': [{'id': 'mp3',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'audio/mpeg',
                                 'width': 10}}],
   'id': 'simpleMediaMP3MultipleAudience',
   'name': 'Distribution with MP3 simple Media Multiple Audience',
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_44765_POST_Distributions_Distributions_Multiple_Audience_Simple_Media_Mp3(self, context):
        """TC-44765 - Distributions-POST
           Verify that user is able to send simple streaming media file(wmv,flv,mp3,wma,mp4) for distribution using request POST "/distributions" with multiple Audience(Standalone and Videonet)."""
        # Define a test step
