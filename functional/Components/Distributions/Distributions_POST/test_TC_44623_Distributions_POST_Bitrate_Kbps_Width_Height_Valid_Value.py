...
* TC-44623 - Distributions POST:

  Verify that user is able to create Distribution  if valid value for  'bitrateKbps/width/height' parameter under streamMetadata is provided using request POST /distributions .
  ...
  {'activationDate': '2017-09-06T07:36:46.542Z',
   ...
   'files': [{'id': 'FileID123',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'Video/mp4',
                                 'width': 10}}],
   'id': 'bitrateKbps_width_height_ValidValue1',
   'name': 'bitrateKbps_width_height_ValidValue1',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44623')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44623_POST_Distributions_Bitrate_Kbps_Width_Height_Valid_Value(self, context):
        """TC-44623 - Distributions-POST
           Verify that user is able to create Distribution  if valid value for  'bitrateKbps/width/height' parameter under streamMetadata is provided using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create Distribution  if valid value for  'bitrateKbps/width/height' parameter under streamMetadata is provided using request POST /distributions ."""):
