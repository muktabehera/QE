...
* TC-43890 - Distributions POST:

  Verify that Vod program having flv file plays with Origin VNE group used as origin under Route Delivery System in QED.
  ...
  {'activationDate': '2017-09-04T07:36:46.542Z',
   ...
   'files': [{'id': 'flv',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'video/flv',
                                 'width': 10}}],
   'id': 'FLV_GroupOriginVNE',
   'name': 'Distribution with FLV_Group_OriginVNE',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43890')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_43890_POST_Distributions_Vne_Route_Flvfile_Origin_Vne(self, context):
        """TC-43890 - Distributions-POST
           Verify that Vod program having flv file plays with Origin VNE group used as origin under Route Delivery System in QED."""
        # Define a test step
        with pytest.allure.step("""Verify that Vod program having flv file plays with Origin VNE group used as origin under Route Delivery System in QED."""):
