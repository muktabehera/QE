  ...
  {'activationDate': '2017-09-11T07:36:46.542Z',
   ...
   'files': [{'id': 'wma',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'video/wmv',
                                 'width': 10}}],
   'id': 'simpleMediaWMADist_OriginEdgeGroup',
   'name': 'WMA Distribution with orgin Edge Group',
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_46867_POST_Distributions_Vne_Dist_Origin_Edge_Group_Simple_Media_Wma(self, context):
        """TC-46867 - Distributions-POST
           Verify that VOD program having WMA file is played successfully using 'VNE Route (Origin Group Distribution Standalone VNE Edge Group)' Delivery System in QED."""
        # Define a test step
