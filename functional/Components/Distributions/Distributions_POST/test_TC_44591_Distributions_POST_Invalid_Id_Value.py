...
* TC-44591 - Distributions POST:

  Verify that user is unable to create Distribution if invalid value(starting with special characters) is provided in 'ID' parameter using request POST /distributions .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44591')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44591_POST_Distributions_Invalid_Id_Value(self, context):
        """TC-44591 - Distributions-POST
           Verify that user is unable to create Distribution if invalid value(starting with special characters) is provided in 'ID' parameter using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create Distribution if invalid value(starting with special characters) is provided in 'ID' parameter using request POST /distributions ."""):
