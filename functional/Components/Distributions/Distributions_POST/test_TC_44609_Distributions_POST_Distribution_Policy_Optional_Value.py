...
* TC-44609 - Distributions POST:

  Verify that user is able to create Distribution if' OPTIONAL' value is provided for 'distributionPolicy' parameter  using request POST /distributions .
  ...
  {'activationDate': '2017-09-06T07:36:46.542Z',
   ...
   'files': [{'id': 'sample123',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'Video/mp4',
                                 'width': 10}}],
   'id': 'distributionPolicy_OPTIONALvalue',
   'name': 'distributionPolicy_OPTIONALvalue',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44609')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44609_POST_Distributions_Distribution_Policy_Optional_Value(self, context):
        """TC-44609 - Distributions-POST
           Verify that user is able to create Distribution if' OPTIONAL' value is provided for 'distributionPolicy' parameter  using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create Distribution if' OPTIONAL' value is provided for 'distributionPolicy' parameter  using request POST /distributions ."""):
