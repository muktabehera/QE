...
* TC-44908 - Distributions POST:

  Verify that VOD program having FLV file is played successfully using 'VNE Route (Origin Group  Edge Group)' Delivery System in QED.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44908')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44908_POST_Distributions_Vne_Route_Flvfile(self, context):
        """TC-44908 - Distributions-POST
           Verify that VOD program having FLV file is played successfully using 'VNE Route (Origin Group  Edge Group)' Delivery System in QED."""
        # Define a test step
        with pytest.allure.step("""Verify that VOD program having FLV file is played successfully using 'VNE Route (Origin Group  Edge Group)' Delivery System in QED."""):
