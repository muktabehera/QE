...
* TC-46861 - Distributions POST:

  Verify that VOD program having HLS file is played successfully using VNE Route (Origin 2 Standalone VNEs Distribution VNEGroupEdge 2 Standalone VNEs) Delivery System in QED.
  ...
  {'activationDate': '2017-09-11T07:36:46.542Z',
   ...
   'files': [{'auxiliaryFiles': [{'relativeUrl': 'qumu_4e322c4a016e4f698783f006065468df_HLS_time1_1.m3u8'},
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'width': 10}}],
   'id': 'adaptiveMediaHLSDistGroup_2OriginEdge',
   'name': 'HLS Distribution with Dist Group and Origin Edge',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46861')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_46861_POST_Distributions_Vne_Dist_Group_2_Origin_Edge_Adaptive_Media_Hls(self, context):
        """TC-46861 - Distributions-POST
           Verify that VOD program having HLS file is played successfully using VNE Route (Origin 2 Standalone VNEs Distribution VNEGroupEdge 2 Standalone VNEs) Delivery System in QED."""
        # Define a test step
        with pytest.allure.step("""Verify that VOD program having HLS file is played successfully using VNE Route (Origin 2 Standalone VNEs Distribution VNEGroupEdge 2 Standalone VNEs) Delivery System in QED."""):
