...
* TC-44607 - Distributions POST:

  Verify that user is unable to create Distribution  if  'distributionPolicy' parameter is not provided using request POST /distributions .
  ...
  {'activationDate': '2017-09-06T07:36:46.542Z',
   ...
   'files': [{'id': 'sample123',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'Video/mp4',
                                 'width': 10}}],
   'id': 'distributionPolicy_emptyvalue',
   'name': 'distributionPolicy_emptyvalue',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44607')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44607_POST_Distributions_Distribution_Policy_Emptyvalue(self, context):
        """TC-44607 - Distributions-POST
           Verify that user is unable to create Distribution  if  'distributionPolicy' parameter is not provided using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create Distribution  if  'distributionPolicy' parameter is not provided using request POST /distributions ."""):
