...
* TC-44622 - Distributions POST:

  Verify that user is able to create Distribution  if valid value for  'Mimetype' parameter under streamMetadata is provided using request POST /distributions .
  ...
  {'activationDate': '2017-09-06T07:36:46.542Z',
   ...
   'files': [{'id': 'FileID123',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'Video/mp4',
                                 'width': 10}}],
   'id': 'streamMetadata_mimeType_ValidValue',
   'name': 'streamMetadata_mimeType_ValidValue',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44622')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44622_POST_Distributions_Mimetype_Valid_Value(self, context):
        """TC-44622 - Distributions-POST
           Verify that user is able to create Distribution  if valid value for  'Mimetype' parameter under streamMetadata is provided using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create Distribution  if valid value for  'Mimetype' parameter under streamMetadata is provided using request POST /distributions ."""):
