...
* TC-44594 - Distributions POST:

  Verify that user is unable to create Distribution with same 'ID'  using request POST /distributions .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44594')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44594_POST_Distributions_Duplicate_Id(self, context):
        """TC-44594 - Distributions-POST
           Verify that user is unable to create Distribution with same 'ID'  using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create Distribution with same 'ID'  using request POST /distributions ."""):
