...
* TC-43892 - Distributions POST:

  Verify that Vod program having mp3 file plays with Origin VNE group used as origin under Route Delivery System in QED.
  ...
  {'activationDate': '2017-09-04T07:36:46.542Z',
   ...
   'files': [{'id': 'mp3',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'video/mp3',
                                 'width': 10}}],
   'id': 'MP3_Group_OriginVNE',
   'name': 'Distribution with MP3_Group_OriginVNE',
   'targetAudiences': [{'id': 'AudienceOriginGroup'}]}
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43892')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_43892_POST_Distributions_Vne_Route_Mp3File_Origin_Vne(self, context):
        """TC-43892 - Distributions-POST
           Verify that Vod program having mp3 file plays with Origin VNE group used as origin under Route Delivery System in QED."""
        # Define a test step
        with pytest.allure.step("""Verify that Vod program having mp3 file plays with Origin VNE group used as origin under Route Delivery System in QED."""):
