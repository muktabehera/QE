...
* TC-43354 - Distributions POST:

  Verify that Vod program having MP4 file plays with Origin VNE group used as origin under Route Delivery System in QED.
  ...
  {'activationDate': '2017-09-04T07:36:46.542Z',
   ...
   'files': [{'id': 'mp4',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'video/mp4',
                                 'width': 10}}],
   'id': 'MP4_Group_OriginVNE',
   'name': 'Distribution with MP4_Group_Origin',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43354')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_43354_POST_Distributions_Vne_Route_Mp4File_Origin_Vne(self, context):
        """TC-43354 - Distributions-POST
           Verify that Vod program having MP4 file plays with Origin VNE group used as origin under Route Delivery System in QED."""
        # Define a test step
        with pytest.allure.step("""Verify that Vod program having MP4 file plays with Origin VNE group used as origin under Route Delivery System in QED."""):
