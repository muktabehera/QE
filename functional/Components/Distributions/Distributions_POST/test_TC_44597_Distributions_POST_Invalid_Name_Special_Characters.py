...
* TC-44597 - Distributions POST:

  Verify that user is unable to create Distribution if invalid value (starting with special characters) is provided in 'Name' parameter using request POST /distributions .
  ...
  {'activationDate': '2017-09-04T07:36:46.542Z',
   ...
   'files': [{'id': 'sample123',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'Video/mp4',
                                 'width': 10}}],
   'id': 'Special_character_value for Name',
   'name': '@#$%^&*',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44597')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44597_POST_Distributions_Invalid_Name_Special_Characters(self, context):
        """TC-44597 - Distributions-POST
           Verify that user is unable to create Distribution if invalid value (starting with special characters) is provided in 'Name' parameter using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create Distribution if invalid value (starting with special characters) is provided in 'Name' parameter using request POST /distributions ."""):
