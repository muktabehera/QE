...
* TC-44619 - Distributions POST:

  Verify that user is able to create Distribution  if valid value in  'sourceUrl' parameter is provided using request POST /distributions .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44619')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44619_POST_Distributions_Source_Url_Valid_Value(self, context):
        """TC-44619 - Distributions-POST
           Verify that user is able to create Distribution  if valid value in  'sourceUrl' parameter is provided using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create Distribution  if valid value in  'sourceUrl' parameter is provided using request POST /distributions ."""):
