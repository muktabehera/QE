...
* TC-44612 - Distributions POST:

  Verify that user is able to create Distribution with same file 'ID' provided using request POST /distributions .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44612')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44612_POST_Distributions_Same_File_Id(self, context):
        """TC-44612 - Distributions-POST
           Verify that user is able to create Distribution with same file 'ID' provided using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create Distribution with same file 'ID' provided using request POST /distributions ."""):
