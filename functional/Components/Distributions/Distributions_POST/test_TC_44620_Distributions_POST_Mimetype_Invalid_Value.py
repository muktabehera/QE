...
* TC-44620 - Distributions POST:

  Verify that user is unable to create Distribution  if invalid value for  'Mimetype' parameter under streamMetadata is provided using request POST /distributions .
  ...
  {'activationDate': '2017-09-06T07:36:46.542Z',
   ...
   'files': [{'id': 'FileID123',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': '#^$%',
                                 'width': 10}}],
   'id': 'streamMetadata_mimeType_invalidValue',
   'name': 'streamMetadata_mimeType_invalidValue',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44620')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44620_POST_Distributions_Mimetype_Invalid_Value(self, context):
        """TC-44620 - Distributions-POST
           Verify that user is unable to create Distribution  if invalid value for  'Mimetype' parameter under streamMetadata is provided using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create Distribution  if invalid value for  'Mimetype' parameter under streamMetadata is provided using request POST /distributions ."""):
