...
* TC-44625 - Distributions POST:

  Verify that user is unable to create Distribution  if targetAudiences 'ID' parameter is not provided using request POST /distributions .
...
JSON data sent to PathFinder in this test:
  ...
  {'activationDate': '2017-09-06T07:36:46.542Z',
   ...
   'name': 'Distribution with Audience not provided',
   'targetAudiences': [{'id': ''}]}
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44625')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44625_POST_Distributions_Audience_Id_Not_Provided(self, context):
        """TC-44625 - Distributions-POST
           Verify that user is unable to create Distribution  if targetAudiences 'ID' parameter is not provided using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create Distribution  if targetAudiences 'ID' parameter is not provided using request POST /distributions ."""):
