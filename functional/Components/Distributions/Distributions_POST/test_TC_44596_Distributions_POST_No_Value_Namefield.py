...
* TC-44596 - Distributions POST:

  Verify that user is unable to create Distribution  if 'Name' parameter is not provided using request POST /distributions .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44596')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44596_POST_Distributions_No_Value_Namefield(self, context):
        """TC-44596 - Distributions-POST
           Verify that user is unable to create Distribution  if 'Name' parameter is not provided using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create Distribution  if 'Name' parameter is not provided using request POST /distributions ."""):
