...
* TC-44606 - Distributions POST:

  Verify that user is unable to create Distribution if invalid value is provided in the 'activationDate' parameter using request POST /distributions .
...
JSON data sent to PathFinder in this test:
  ...
  {'activationDate': '2017-08T07:36:46.542Z',
   ...
   'files': [{'id': 'sample123',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'Video/mp4',
                                 'width': 10}}],
   'id': 'activationDate_invalid',
   'name': 'activationDate_invalid',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44606')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44606_POST_Distributions_Activation_Date_Invalidvalue(self, context):
        """TC-44606 - Distributions-POST
           Verify that user is unable to create Distribution if invalid value is provided in the 'activationDate' parameter using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create Distribution if invalid value is provided in the 'activationDate' parameter using request POST /distributions ."""):
