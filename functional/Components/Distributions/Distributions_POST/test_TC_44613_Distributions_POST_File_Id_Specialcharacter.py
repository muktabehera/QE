...
* TC-44613 - Distributions POST:

  Verify that user is unable to create Distribution if invalid value(starting with special characters) is provided in file 'ID' parameter using request POST /distributions .
  ...
  {'activationDate': '2017-09-06T07:36:46.542Z',
   ...
   'files': [{'id': '@#$%%^stream1',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'Video/mp4',
                                 'width': 10}}],
   'id': 'FileID_specialcharacter',
   'name': 'FileID_specialcharacter',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44613')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44613_POST_Distributions_File_Id_Specialcharacter(self, context):
        """TC-44613 - Distributions-POST
           Verify that user is unable to create Distribution if invalid value(starting with special characters) is provided in file 'ID' parameter using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create Distribution if invalid value(starting with special characters) is provided in file 'ID' parameter using request POST /distributions ."""):
