...
* TC-44608 - Distributions POST:

  Verify that user is able to create Distribution if 'REQUIRED' value is provided for 'distributionPolicy' parameter using request POST /distributions .
  ...
  {'activationDate': '2017-09-06T07:36:46.542Z',
   ...
   'files': [{'id': 'sample123',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'Video/mp4',
                                 'width': 10}}],
   'id': 'distributionPolicy_REQUIREDvalue',
   'name': 'distributionPolicy_REQUIREDvalue',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44608')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44608_POST_Distributions_Distribution_Policy_R_Eq_U_I_R_E_Dvalue(self, context):
        """TC-44608 - Distributions-POST
           Verify that user is able to create Distribution if 'REQUIRED' value is provided for 'distributionPolicy' parameter using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create Distribution if 'REQUIRED' value is provided for 'distributionPolicy' parameter using request POST /distributions ."""):
