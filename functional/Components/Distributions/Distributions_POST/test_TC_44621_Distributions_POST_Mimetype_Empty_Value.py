...
* TC-44621 - Distributions POST:

  Verify that user is unable to create Distribution if empty value for 'Mimetype' parameter is provided using request POST /distributions .
  ...
  {'activationDate': '2017-09-06T07:36:46.542Z',
   ...
   'files': [{'id': 'FileID123',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': '',
                                 'width': 10}}],
   'id': 'streamMetadata_mimeType_EmptyValue',
   'name': 'streamMetadata_mimeType_EmptyValue',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44621')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44621_POST_Distributions_Mimetype_Empty_Value(self, context):
        """TC-44621 - Distributions-POST
           Verify that user is unable to create Distribution if empty value for 'Mimetype' parameter is provided using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create Distribution if empty value for 'Mimetype' parameter is provided using request POST /distributions ."""):
