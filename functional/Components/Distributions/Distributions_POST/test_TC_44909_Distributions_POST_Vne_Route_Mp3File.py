...
* TC-44909 - Distributions POST:

  Verify that VOD program having MP3 file is played successfully using 'VNE Route (Origin Group  Edge Group)' Delivery System in QED.
  ...
  {'activationDate': '2017-09-04T07:36:46.542Z',
   ...
   'files': [{'id': 'mp3',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'video/mp3',
                                 'width': 10}}],
   'id': 'MP3_Group_Origin_Edge',
   'name': 'Distribution with MP3_Group_OriginEdge',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44909')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44909_POST_Distributions_Vne_Route_Mp3File(self, context):
        """TC-44909 - Distributions-POST
           Verify that VOD program having MP3 file is played successfully using 'VNE Route (Origin Group  Edge Group)' Delivery System in QED."""
        # Define a test step
        with pytest.allure.step("""Verify that VOD program having MP3 file is played successfully using 'VNE Route (Origin Group  Edge Group)' Delivery System in QED."""):
