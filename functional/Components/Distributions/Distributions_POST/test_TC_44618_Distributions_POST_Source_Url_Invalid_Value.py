...
* TC-44618 - Distributions POST:

  Verify that user is unable to create Distribution  if invalid value in  'sourceUrl' parameter is provided using request POST /distributions .
  ...
  {'activationDate': '2017-09-06T07:36:46.542Z',
   ...
   'files': [{'id': 'FileID123',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'Video/mp4',
                                 'width': 10}}],
   'id': 'sourceUrl_validValue1',
   'name': 'sourceUrl_validValue2',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44618')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44618_POST_Distributions_Source_Url_Invalid_Value(self, context):
        """TC-44618 - Distributions-POST
           Verify that user is unable to create Distribution  if invalid value in  'sourceUrl' parameter is provided using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create Distribution  if invalid value in  'sourceUrl' parameter is provided using request POST /distributions ."""):
