...
* TC-44598 - Distributions POST:

  Verify that user is able to create Distribution on providing valid value (Starting with  letter) in 'Name' parameter using request POST /distributions .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44598')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_44598_POST_Distributions_Valid_Name(self, context):
        """TC-44598 - Distributions-POST
           Verify that user is able to create Distribution on providing valid value (Starting with  letter) in 'Name' parameter using request POST /distributions ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create Distribution on providing valid value (Starting with  letter) in 'Name' parameter using request POST /distributions ."""):
