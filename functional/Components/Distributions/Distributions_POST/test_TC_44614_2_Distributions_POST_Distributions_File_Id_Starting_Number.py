  ...
  {'activationDate': '2017-09-06T07:36:46.542Z',
   ...
   'files': [{'id': '11',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'Video/mp4',
                                 'width': 10}}],
   'id': 'FileID_startingwith_number',
   'name': 'FileID_startingwith_number',
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_44614_POST_Distributions_Distributions_File_Id_Starting_Number(self, context):
        """TC-44614 - Distributions-POST
           Verify that user is able to create Distribution on providing valid value (Starting with  letter or number) in file 'ID' parameter using request POST /distributions ."""
        # Define a test step
