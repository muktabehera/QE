...
* TC-43893 - Distributions POST:

  Verify that Vod program having mp3 file plays with Edge VNE group used as child under Route Delivery System in QED.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43893')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_43893_POST_Distributions_Vne_Route_Mp3File_Edge_Vne(self, context):
        """TC-43893 - Distributions-POST
           Verify that Vod program having mp3 file plays with Edge VNE group used as child under Route Delivery System in QED."""
        # Define a test step
        with pytest.allure.step("""Verify that Vod program having mp3 file plays with Edge VNE group used as child under Route Delivery System in QED."""):
