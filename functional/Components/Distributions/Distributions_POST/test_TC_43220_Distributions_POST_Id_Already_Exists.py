...
* TC-43220 - Distributions POST:

  Verify that user is unable to send  file for distribution with duplicate ID using request POST "/distributions" with Videonet.
...
JSON data sent to PathFinder in this test:
  ...
  {'activationDate': '2017-09-04T07:36:46.542Z',
   ...
   'name': 'Distribution with Duplicate Id',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43220')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_43220_POST_Distributions_Id_Already_Exists(self, context):
        """TC-43220 - Distributions-POST
           Verify that user is unable to send  file for distribution with duplicate ID using request POST "/distributions" with Videonet."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to send  file for distribution with duplicate ID using request POST "/distributions" with Videonet."""):
