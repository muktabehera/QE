...
* TC-43353 - Distributions POST:

  Verify that Vod program having MP4 file plays with Edge VNE group used as child under Route Delivery System in QED. .
  ...
  {'activationDate': '2017-09-04T07:36:46.542Z',
   ...
   'files': [{'id': 'mp4',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'video/mp4',
                                 'width': 10}}],
   'id': 'MP4_Group_EdgeVNE',
   'name': 'Distribution with MP4_Group_OriginEdge',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43353')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_43353_POST_Distributions_Vne_Route_Mp4File_Edge_Vne(self, context):
        """TC-43353 - Distributions-POST
           Verify that Vod program having MP4 file plays with Edge VNE group used as child under Route Delivery System in QED. ."""
        # Define a test step
        with pytest.allure.step("""Verify that Vod program having MP4 file plays with Edge VNE group used as child under Route Delivery System in QED. ."""):
