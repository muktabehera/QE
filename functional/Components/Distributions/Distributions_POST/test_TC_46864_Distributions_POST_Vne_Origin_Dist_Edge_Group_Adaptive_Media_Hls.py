...
* TC-46864 - Distributions POST:

  Verify that VOD program having HLS file is played successfully using 'VNE Route (Origin Standalone VNE Distribution Standalone VNEVNE Edge Group)' Delivery System in QED.
  ...
  {'activationDate': '2017-09-11T07:36:46.542Z',
   ...
   'files': [{'auxiliaryFiles': [{'relativeUrl': 'qumu_4e322c4a016e4f698783f006065468df_HLS_time1_1.m3u8'},
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'width': 10}}],
   'id': 'adaptiveMediaHLSOriginDist_EdgeGroup',
   'name': 'HLS Distribution with Edge Group',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46864')
    @pytest.mark.Distributions
    @pytest.mark.POST
    def test_TC_46864_POST_Distributions_Vne_Origin_Dist_Edge_Group_Adaptive_Media_Hls(self, context):
        """TC-46864 - Distributions-POST
           Verify that VOD program having HLS file is played successfully using 'VNE Route (Origin Standalone VNE Distribution Standalone VNEVNE Edge Group)' Delivery System in QED."""
        # Define a test step
        with pytest.allure.step("""Verify that VOD program having HLS file is played successfully using 'VNE Route (Origin Standalone VNE Distribution Standalone VNEVNE Edge Group)' Delivery System in QED."""):
