...
JSON data sent to PathFinder in this test:
  ...
  {'activationDate': '2017-09-20T07:36:46.542Z',
   ...
   'files': [{'id': 'htmlVNEtopt',
              'sourceUrl': 'qedorigin://Auto_storage/html.html',
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'width': 10}}],
   'id': 'vnetHTMLFileOpt',
   'name': 'Distribution with VNET html File opt',
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_43681_POST_Distributions_Distributions_Vnet_Html_File(self, context):
        """TC-43681 - Distributions-POST
           Verify that user is able to send document(doc, docx,html) for distribution using request POST "/distributions" with VideoNet  as public delivery system."""
        # Define a test step
