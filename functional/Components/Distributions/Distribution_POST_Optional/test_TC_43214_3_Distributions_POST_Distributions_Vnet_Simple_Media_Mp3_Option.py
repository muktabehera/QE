  ...
  {'activationDate': '2017-09-20T07:36:46.542Z',
   ...
   'files': [{'id': 'videonetmp3Opt',
              ...
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'mimeType': 'audio/mpeg',
                                 'width': 10}}],
   'id': 'vnetSimpleMediaMP3Opt',
   'name': 'Distribution with VNET MP3 Opt',
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_43214_POST_Distributions_Distributions_Vnet_Simple_Media_Mp3(self, context):
        """TC-43214 - Distributions-POST
           Verify that user is able to send simple streaming media file(wmv,flv,mp3,wma,mp4) for distribution using request POST "/distributions" with Videonet."""
        # Define a test step
