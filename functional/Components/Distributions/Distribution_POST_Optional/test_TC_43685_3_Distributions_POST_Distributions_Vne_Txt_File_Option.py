...
JSON data sent to PathFinder in this test:
  ...
  {'activationDate': '2017-09-20T07:36:46.542Z',
   ...
   'files': [{'id': 'txtVNETOpt',
              'sourceUrl': 'qedorigin://Auto_storage/txtFile.txt',
              'streamMetadata': {'bitrateKbps': 100,
                                 ...
                                 'width': 10}}],
   'id': 'vnetTxtFileOpt',
   'name': 'Distribution with VNET Txt File Opt',
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_43685_POST_Distributions_Distributions_Vne_Txt_File(self, context):
        """TC-43685 - Distributions-POST
           Verify that user is able to send document(xls, xlsx,txt) for distribution using request POST "/distributions" with VideoNet  as public delivery system."""
        # Define a test step
