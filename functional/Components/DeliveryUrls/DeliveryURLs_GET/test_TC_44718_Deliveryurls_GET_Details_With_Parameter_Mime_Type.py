...
* TC-44718 - Delivery_Urls GET:

  Verify that user is able to GET the details of delivery URLs with parameter "mimeType" using request "/deliveryUrls".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44718')
    @pytest.mark.Delivery_Urls
    @pytest.mark.GET
    def test_TC_44718_GET_Delivery_Urls_Details_With_Parameter_Mime_Type(self, context):
        """TC-44718 - Delivery_Urls-GET
           Verify that user is able to GET the details of delivery URLs with parameter "mimeType" using request "/deliveryUrls"."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to GET the details of delivery URLs with parameter "mimeType" using request "/deliveryUrls"."""):
