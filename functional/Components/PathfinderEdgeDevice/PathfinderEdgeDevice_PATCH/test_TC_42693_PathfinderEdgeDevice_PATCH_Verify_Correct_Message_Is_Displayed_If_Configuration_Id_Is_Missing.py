...
* TC-42693 - Pathfinder_Edge_Device PATCH:

  Verify that correct message is displayed for mandatory fields (configurations ID) PATCH "/devices/veDevices/{id}".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42693')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.PATCH
    def test_TC_42693_PATCH_Pathfinder_Edge_Device_Verify_Correct_Message_Is_Displayed_If_Configuration_Id_Is_Missing(self, context):
        """TC-42693 - Pathfinder_Edge_Device-PATCH
           Verify that correct message is displayed for mandatory fields (configurations ID) PATCH "/devices/veDevices/{id}"."""
        # Define a test step
        with pytest.allure.step("""Verify that correct message is displayed for mandatory fields (configurations ID) PATCH "/devices/veDevices/{id}"."""):
