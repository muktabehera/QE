...
* TC-44136 - Pathfinder_Edge_Device PATCH:

  Verify that user is un-able to create VE device on providing Characters more than 250 in Device Host field using request PATCH /devices/veDevices/{id}.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44136')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.PATCH
    def test_TC_44136_PATCH_Pathfinder_Edge_Device_Maxlength_Exceed_For_Device_Host(self, context):
        """TC-44136 - Pathfinder_Edge_Device-PATCH
           Verify that user is un-able to create VE device on providing Characters more than 250 in Device Host field using request PATCH /devices/veDevices/{id}."""
        # Define a test step
        with pytest.allure.step("""Verify that user is un-able to create VE device on providing Characters more than 250 in Device Host field using request PATCH /devices/veDevices/{id}."""):
