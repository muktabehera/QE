...
* TC-42689 - Pathfinder_Edge_Device PATCH:

  Verify that user is able to update (enable all config,admin to edit) videoEdge device using PATCH "/devices/veDevices/{id}".
...
JSON data sent to PathFinder in this test:
  ...
  {'alertCount': 0,
   ...
   'name': 'PATCHDevicesUpdateAllConfigAdminConfig',
   'online': False,
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42689')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.PATCH
    def test_TC_42689_PATCH_Pathfinder_Edge_Device_Able_Update_Enable_All_Config_Admin_Edit(self, context):
        """TC-42689 - Pathfinder_Edge_Device-PATCH
           Verify that user is able to update (enable all config,admin to edit) videoEdge device using PATCH "/devices/veDevices/{id}"."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to update (enable all config,admin to edit) videoEdge device using PATCH "/devices/veDevices/{id}"."""):
