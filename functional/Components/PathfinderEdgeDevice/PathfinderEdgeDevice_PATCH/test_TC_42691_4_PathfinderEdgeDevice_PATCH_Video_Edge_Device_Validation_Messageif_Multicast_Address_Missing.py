...
* TC-42691 - Pathfinder_Edge_Device PATCH:

  Verify that validation message is displayed for mandatory fields(name,profileid,devicehost,multicast address) PATCH "/devices/veDevices/{id}".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42691')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.PATCH
    def test_TC_42691_PATCH_Pathfinder_Edge_Device_Video_Edge_Device_Validation_Messageif_Multicast_Address_Missing(self, context):
        """TC-42691 - Pathfinder_Edge_Device-PATCH
           Verify that validation message is displayed for mandatory fields(name,profileid,devicehost,multicast address) PATCH "/devices/veDevices/{id}"."""
        # Define a test step
        with pytest.allure.step("""Verify that validation message is displayed for mandatory fields(name,profileid,devicehost,multicast address) PATCH "/devices/veDevices/{id}"."""):
