...
* TC-42692 - Pathfinder_Edge_Device PATCH:

  Verify that validation message is displayed for mandatory fields (ID) PATCH "/devices/veDevices/{id}".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42692')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.PATCH
    def test_TC_42692_PATCH_Pathfinder_Edge_Device_Verify_Mandatory_Messagefor_Id_Is_Displayed_If_Missing(self, context):
        """TC-42692 - Pathfinder_Edge_Device-PATCH
           Verify that validation message is displayed for mandatory fields (ID) PATCH "/devices/veDevices/{id}"."""
        # Define a test step
        with pytest.allure.step("""Verify that validation message is displayed for mandatory fields (ID) PATCH "/devices/veDevices/{id}"."""):
