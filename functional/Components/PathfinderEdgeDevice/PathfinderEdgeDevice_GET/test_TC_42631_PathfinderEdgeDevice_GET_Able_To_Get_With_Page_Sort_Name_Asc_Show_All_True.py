...
* TC-42631 - Pathfinder_Edge_Device GET:
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.GET
    def test_TC_42631_GET_Pathfinder_Edge_Device_Able_To_Get_With_Page_Sort_Name_Asc_Show_All_True(self, context):
        """TC-42631 - Pathfinder_Edge_Device-GET
           Verify that user is able to GET the details of VideoEdge device  request /devices/veDevices  with page,sort=name;asc and showall=true parameter ."""
        # Define a test step
