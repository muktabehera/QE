...
* TC-44142 - Pathfinder_Edge_Device POST:

  Verify device ID does not begin with a special character using request POST /devices/veDevices.
...
JSON data sent to PathFinder in this test:
  ...
  {'configAdminCanEdit': False,
   ...
   'id': '@@#$%POST_videoEdgeDevice_startIDwithSpecialCharacter',
   'multicastHost': 'abc.com',
   'name': 'POST_videoEdgeDevice_startIDwithSpecialCharacter',
   'online': False,
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44142')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.POST
    def test_TC_44142_POST_Pathfinder_Edge_Device_Start_Idwith_Special_Character(self, context):
        """TC-44142 - Pathfinder_Edge_Device-POST
           Verify device ID does not begin with a special character using request POST /devices/veDevices."""
        # Define a test step
        with pytest.allure.step("""Verify device ID does not begin with a special character using request POST /devices/veDevices."""):
