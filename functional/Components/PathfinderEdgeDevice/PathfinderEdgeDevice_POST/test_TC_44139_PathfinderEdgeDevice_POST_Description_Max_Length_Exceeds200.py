...
* TC-44139 - Pathfinder_Edge_Device POST:

  Verify that user is un-able to create VE device on providing Characters more than 200 in Description field using request POST /devices/veDevices.
...
JSON data sent to PathFinder in this test:
  ...
  {'configAdminCanEdit': False,
   ...
   'id': 'POST_videoEdgeDevice_descriptionMaxLengthExceeds200',
   'multicastHost': 'abc.com',
   'name': 'POST_videoEdgeDevice_descriptionMaxLengthExceeds200',
   'online': False,
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44139')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.POST
    def test_TC_44139_POST_Pathfinder_Edge_Device_Description_Max_Length_Exceeds200(self, context):
        """TC-44139 - Pathfinder_Edge_Device-POST
           Verify that user is un-able to create VE device on providing Characters more than 200 in Description field using request POST /devices/veDevices."""
        # Define a test step
        with pytest.allure.step("""Verify that user is un-able to create VE device on providing Characters more than 200 in Description field using request POST /devices/veDevices."""):
