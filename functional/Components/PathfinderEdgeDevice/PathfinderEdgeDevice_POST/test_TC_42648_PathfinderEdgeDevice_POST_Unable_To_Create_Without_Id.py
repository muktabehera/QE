...
* TC-42648 - Pathfinder_Edge_Device POST:

  Verify that user is unable to create VideoEdge device without providing "id" value for POST request  /devices/veDevices .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42648')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.POST
    def test_TC_42648_POST_Pathfinder_Edge_Device_Unable_To_Create_Without_Id(self, context):
        """TC-42648 - Pathfinder_Edge_Device-POST
           Verify that user is unable to create VideoEdge device without providing "id" value for POST request  /devices/veDevices ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create VideoEdge device without providing "id" value for POST request  /devices/veDevices ."""):
