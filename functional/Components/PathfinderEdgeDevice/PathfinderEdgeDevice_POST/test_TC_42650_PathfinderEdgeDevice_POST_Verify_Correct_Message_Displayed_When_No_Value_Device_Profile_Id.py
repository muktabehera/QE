...
* TC-42650 - Pathfinder_Edge_Device POST:

  Verify that correct message is displayed for "deviceProfileId" having no value for POST request  /devices/veDevices .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42650')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.POST
    def test_TC_42650_POST_Pathfinder_Edge_Device_Verify_Correct_Message_Displayed_When_No_Value_Device_Profile_Id(self, context):
        """TC-42650 - Pathfinder_Edge_Device-POST
           Verify that correct message is displayed for "deviceProfileId" having no value for POST request  /devices/veDevices ."""
        # Define a test step
        with pytest.allure.step("""Verify that correct message is displayed for "deviceProfileId" having no value for POST request  /devices/veDevices ."""):
