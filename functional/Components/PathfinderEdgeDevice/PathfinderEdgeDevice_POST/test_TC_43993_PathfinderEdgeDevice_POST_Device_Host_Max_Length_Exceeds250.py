...
* TC-43993 - Pathfinder_Edge_Device POST:

  Verify that user is un-able to create VE device on providing Characters more than 250 in Device Host field using request POST /devices/veDevices.
...
JSON data sent to PathFinder in this test:
  ...
  {'alertCount': 0,
   ...
   'deviceHost': 'http://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.comhttp://abc@abc.com',
   'deviceProfileId': 'No_proxy_profile_POST',
   'edgeDeviceRoles': ['ORIGIN', 'EDGE', 'DISTRIBUTION'],
   'id': 'POST_videoEdgeDevice_deviceHostMaxLengthExceeds250',
   'multicastHost': 'POST_veDevices',
   'name': 'POST_videoEdgeDevice_deviceHostMaxLengthExceeds250',
   'online': False,
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43993')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.POST
    def test_TC_43993_POST_Pathfinder_Edge_Device_Device_Host_Max_Length_Exceeds250(self, context):
        """TC-43993 - Pathfinder_Edge_Device-POST
           Verify that user is un-able to create VE device on providing Characters more than 250 in Device Host field using request POST /devices/veDevices."""
        # Define a test step
        with pytest.allure.step("""Verify that user is un-able to create VE device on providing Characters more than 250 in Device Host field using request POST /devices/veDevices."""):
