...
* TC-42654 - Pathfinder_Edge_Device POST:

  Verify that user is able to create VideoEdge device[proximityZones, add configurations,Multicast] using POST request  /devices/veDevices .
...
JSON data sent to PathFinder in this test:
  ...
  {'alertCount': 0,
   ...
   'id': 'POST_veDevices_Configuration',
   'multicastHost': 'POST_veDevices',
   'name': 'POST_veDevices_Configuration',
   'online': False,
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42654')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.POST
    def test_TC_42654_POST_Pathfinder_Edge_Device_Video_Edge_Device_Able_To_Create_Proximity_Zones_Configurations_Multicast(self, context):
        """TC-42654 - Pathfinder_Edge_Device-POST
           Verify that user is able to create VideoEdge device[proximityZones, add configurations,Multicast] using POST request  /devices/veDevices ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create VideoEdge device[proximityZones, add configurations,Multicast] using POST request  /devices/veDevices ."""):
