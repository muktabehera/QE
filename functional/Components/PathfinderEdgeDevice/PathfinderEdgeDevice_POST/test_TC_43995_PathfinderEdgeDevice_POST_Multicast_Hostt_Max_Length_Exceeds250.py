...
* TC-43995 - Pathfinder_Edge_Device POST:

  Verify that user is un-able to create VE device on providing Characters more than 250 in multicastHost field using request POST /devices/veDevices.
...
JSON data sent to PathFinder in this test:
  ...
  {'alertCount': 0,
   ...
   'id': 'POST_videoEdgeDevice_multicastHosttMaxLengthExceeds250',
   ...
   'name': 'POST_videoEdgeDevice_multicastHosttMaxLengthExceeds250',
   'online': False,
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43995')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.POST
    def test_TC_43995_POST_Pathfinder_Edge_Device_Multicast_Hostt_Max_Length_Exceeds250(self, context):
        """TC-43995 - Pathfinder_Edge_Device-POST
           Verify that user is un-able to create VE device on providing Characters more than 250 in multicastHost field using request POST /devices/veDevices."""
        # Define a test step
        with pytest.allure.step("""Verify that user is un-able to create VE device on providing Characters more than 250 in multicastHost field using request POST /devices/veDevices."""):
