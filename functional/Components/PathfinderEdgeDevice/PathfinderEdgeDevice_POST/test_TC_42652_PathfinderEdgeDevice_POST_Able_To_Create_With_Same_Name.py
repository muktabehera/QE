...
* TC-42652 - Pathfinder_Edge_Device POST:

  Verify that user is able to create videoEdge device with same name for POST request  /devices/veDevices .
...
JSON data sent to PathFinder in this test:
  ...
  {'alertCount': 0,
   ...
   'id': 'POST_veDevices_AllConfigAdminMulticastTrueNew',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42652')
    @pytest.mark.Pathfinder_Edge_Device
    @pytest.mark.POST
    def test_TC_42652_POST_Pathfinder_Edge_Device_Able_To_Create_With_Same_Name(self, context):
        """TC-42652 - Pathfinder_Edge_Device-POST
           Verify that user is able to create videoEdge device with same name for POST request  /devices/veDevices ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create videoEdge device with same name for POST request  /devices/veDevices ."""):
