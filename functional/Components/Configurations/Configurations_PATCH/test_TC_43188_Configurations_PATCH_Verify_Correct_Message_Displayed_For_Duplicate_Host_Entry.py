...
* TC-43188 - Configurations PATCH:

  Verfiy that correct message is displayed for duplicate configuration host using PATCH request "/configurations/{id}".
...
JSON data sent to PathFinder in this test:
  ...
  {'configAdminCanCreate': False, 'host': 'POST_Configuration1'}
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43188')
    @pytest.mark.Configurations
    @pytest.mark.PATCH
    def test_TC_43188_PATCH_Configurations_Verify_Correct_Message_Displayed_For_Duplicate_Host_Entry(self, context):
        """TC-43188 - Configurations-PATCH
           Verfiy that correct message is displayed for duplicate configuration host using PATCH request "/configurations/{id}"."""
        # Define a test step
        with pytest.allure.step("""Verfiy that correct message is displayed for duplicate configuration host using PATCH request "/configurations/{id}"."""):
