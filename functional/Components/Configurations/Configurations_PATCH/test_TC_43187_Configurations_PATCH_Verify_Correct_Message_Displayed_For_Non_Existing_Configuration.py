...
* TC-43187 - Configurations PATCH:

  Verfiy that correct message is displayed for non-existing configuration using PATCH request "/configurations/{id}".
...
JSON data sent to PathFinder in this test:
  ...
  {'configAdminCanCreate': False, 'host': 'POST_PATCH_Configurations123'}
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43187')
    @pytest.mark.Configurations
    @pytest.mark.PATCH
    def test_TC_43187_PATCH_Configurations_Verify_Correct_Message_Displayed_For_Non_Existing_Configuration(self, context):
        """TC-43187 - Configurations-PATCH
           Verfiy that correct message is displayed for non-existing configuration using PATCH request "/configurations/{id}"."""
        # Define a test step
        with pytest.allure.step("""Verfiy that correct message is displayed for non-existing configuration using PATCH request "/configurations/{id}"."""):
            ...
            configurationDetails = context.sc.ConfigurationDetails(
                ...
                dsId=None,
                host='POST_PATCH_Configurations123',
                id=None,
