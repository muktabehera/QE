...
* TC-45599 - Configurations PATCH:

  Verify that user is unable to Modify[host] with empty value for configuration using request PATCH "/configurations/{id} " .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-45599')
    @pytest.mark.Configurations
    @pytest.mark.PATCH
    def test_TC_45599_PATCH_Configurations_Empty_Value_For_Host(self, context):
        """TC-45599 - Configurations-PATCH
           Verify that user is unable to Modify[host] with empty value for configuration using request PATCH "/configurations/{id} " ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to Modify[host] with empty value for configuration using request PATCH "/configurations/{id} " ."""):
