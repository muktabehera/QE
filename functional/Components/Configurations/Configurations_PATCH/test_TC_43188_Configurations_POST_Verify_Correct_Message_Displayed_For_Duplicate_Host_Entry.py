...
JSON data sent to PathFinder in this test:
  ...
  {'configAdminCanCreate': False,
   'host': 'POST_PATCH_Configurations',
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_43188_POST_Configurations_Verify_Correct_Message_Displayed_For_Duplicate_Host_Entry(self, context):
        """TC-43188 - Configurations-POST
           Verfiy that correct message is displayed for duplicate configuration host using PATCH request "/configurations/{id}"."""
        # Define a test step
