...
JSON data sent to PathFinder in this test:
  ...
  {'configAdminCanCreate': True,
   'host': 'POST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceeds',
   'id': 'POST_hostWithMaxLengthExceeds'}
    ...
    def test_TC_43183_POST_Configurations_Able_To_Create_Configurations(self, context):
        ...
        with pytest.allure.step("""Verfiy that user is able to create configurations using POST request "/configurations"."""):
            ...
            configurationDetails = context.sc.ConfigurationDetails(
                ...
                dsId=None,
                host=
                'POST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceedsPOST_hostWithMaxLengthExceeds',
                id='POST_hostWithMaxLengthExceeds',
