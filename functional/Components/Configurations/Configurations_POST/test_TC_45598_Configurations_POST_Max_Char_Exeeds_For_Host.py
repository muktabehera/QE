...
JSON data sent to PathFinder in this test:
  ...
  {'configAdminCanCreate': True,
   'host': 'POST_idExceedshMaxLength',
   'id': 'POST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLength'}
    ...
    def test_TC_45598_POST_Configurations_Max_Char_Exeeds_For_Host(self, context):
        ...
        with pytest.allure.step("""Verify that user is unable to Modify[host] with value greater than 100 character for configuration using request PATCH "/configurations/{id} " ."""):
            ...
            configurationDetails = context.sc.ConfigurationDetails(
                ...
                host='POST_idExceedshMaxLength',
                id=
                'POST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLengthPOST_idExceedshMaxLength',
