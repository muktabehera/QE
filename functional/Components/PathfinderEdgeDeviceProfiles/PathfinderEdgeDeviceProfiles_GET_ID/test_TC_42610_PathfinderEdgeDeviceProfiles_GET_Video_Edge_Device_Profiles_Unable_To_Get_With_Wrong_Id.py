...
* TC-42610 - Pathfinder_Edge_Device_Profiles GET:

  Verify that user is unable to GET VideoEdge Profile details using wrong ID for GET request "/devices/veProfiles/{id}" .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42610')
    @pytest.mark.Pathfinder_Edge_Device_Profiles
    @pytest.mark.GET
    def test_TC_42610_GET_Pathfinder_Edge_Device_Profiles_Video_Edge_Device_Profiles_Unable_To_Get_With_Wrong_Id(self, context):
        """TC-42610 - Pathfinder_Edge_Device_Profiles-GET
           Verify that user is unable to GET VideoEdge Profile details using wrong ID for GET request "/devices/veProfiles/{id}" ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to GET VideoEdge Profile details using wrong ID for GET request "/devices/veProfiles/{id}" ."""):
