...
* TC-42608 - Pathfinder_Edge_Device_Profiles GET:

  Verify that user is unable to GET VideoEdge Profile for the GET request "/devices/veProfiles/{id}" with invalid token.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42608')
    @pytest.mark.Pathfinder_Edge_Device_Profiles
    @pytest.mark.GET
    def test_TC_42608_GET_Pathfinder_Edge_Device_Profiles_Video_Edge_Device_Profiles_Unable_To_Get_With_Invalid_Token(self, context):
        """TC-42608 - Pathfinder_Edge_Device_Profiles-GET
           Verify that user is unable to GET VideoEdge Profile for the GET request "/devices/veProfiles/{id}" with invalid token."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to GET VideoEdge Profile for the GET request "/devices/veProfiles/{id}" with invalid token."""):
