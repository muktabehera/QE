...
* TC-POST - Pathfinder_Edge_Device_Profiles POST:
...
JSON data sent to PathFinder in this test:
  ...
  {'configAdminCanEdit': False,
   ...
   'description': 'Proxy_profileByID Proxy_profileByID Proxy_profileByID '
                  'Proxy_profile_Delete Proxy_profile_Delete '
                  'Proxy_profile_Delete Proxy_profile Proxy_profile_Delete',
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.POST
    def test_TC_POST_POST_Pathfinder_Edge_Device_Profiles_Id(self, context):
        """TC-POST - Pathfinder_Edge_Device_Profiles-POST
           Id."""
        # Define a test step
