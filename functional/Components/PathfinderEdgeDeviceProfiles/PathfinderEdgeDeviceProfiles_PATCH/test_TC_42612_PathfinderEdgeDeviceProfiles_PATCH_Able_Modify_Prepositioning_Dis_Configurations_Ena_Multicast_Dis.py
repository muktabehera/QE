...
* TC-42612 - Pathfinder_Edge_Device_Profiles PATCH:
...
class Test_PFE_Components(object):
    ...
    @pytest.mark.PATCH
    def test_TC_42612_PATCH_Pathfinder_Edge_Device_Profiles_Able_To_Modify_With_Prepositioning_Disabled_Configurations_Enabled_Multicast_Disabled(self, context):
        """TC-42612 - Pathfinder_Edge_Device_Profiles-PATCH
           Verify that user is able to modify(PATCH)[visible AllConfigurations,enable prepositioing disabled,multicast disabled,rtsp server properties] VideoEdge Profile details using VideoEdge profile ID for request "/devices/veProfiles/{id}" ."""
        # Define a test step
