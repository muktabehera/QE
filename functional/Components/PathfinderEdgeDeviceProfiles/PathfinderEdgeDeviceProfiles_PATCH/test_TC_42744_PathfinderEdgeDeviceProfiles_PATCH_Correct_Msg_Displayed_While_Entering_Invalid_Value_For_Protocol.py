...
* TC-42744 - Pathfinder_Edge_Device_Profiles PATCH:

  Verify that correct message is displayed while updating VideoEdge device profile  using wrong inputs for (protocol)  using PATCH /devices/veProfiles  .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42744')
    @pytest.mark.Pathfinder_Edge_Device_Profiles
    @pytest.mark.PATCH
    def test_TC_42744_PATCH_Pathfinder_Edge_Device_Profiles_Verify_Correct_Message_Displayed_While_Entering_Invalid_Value_For_Protocol(self, context):
        """TC-42744 - Pathfinder_Edge_Device_Profiles-PATCH
           Verify that correct message is displayed while updating VideoEdge device profile  using wrong inputs for (protocol)  using PATCH /devices/veProfiles  ."""
        # Define a test step
        with pytest.allure.step("""Verify that correct message is displayed while updating VideoEdge device profile  using wrong inputs for (protocol)  using PATCH /devices/veProfiles  ."""):
