...
* TC-42613 - Pathfinder_Edge_Device_Profiles PATCH:

  Verify that user is unable to modify(PATCH)[ i.e. proxyMode: test] VideoEdge Profile details for the wrong parameters for request "/devices/veProfiles/{id}" .
...
JSON data sent to PathFinder in this test:
  ...
  {'configAdminCanEdit': True,
   'configurations': [{'guid': '4322b86e-2e32-4134-90da-b8f1d1a0c4e3',
                       'name': 'testUpdate2',
                       'originId': '12Client'},
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42613')
    @pytest.mark.Pathfinder_Edge_Device_Profiles
    @pytest.mark.PATCH
    def test_TC_42613_PATCH_Pathfinder_Edge_Device_Profiles_Unable_To_Modify_With_Invalid_Value_For_Proxy_Mode(self, context):
        """TC-42613 - Pathfinder_Edge_Device_Profiles-PATCH
           Verify that user is unable to modify(PATCH)[ i.e. proxyMode: test] VideoEdge Profile details for the wrong parameters for request "/devices/veProfiles/{id}" ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to modify(PATCH)[ i.e. proxyMode: test] VideoEdge Profile details for the wrong parameters for request "/devices/veProfiles/{id}" ."""):
