...
* TC-42728 - Pathfinder_Edge_Device_Profiles POST:

  Verify that user is able to Create (mulitple configuratons & VOD PPT) VideoEdge device profile using POST /devices/veProfiles  .
  ...
  {'configAdminCanEdit': False,
   ...
   'httpService': {'httpPort': 80,
                   ...
                   'vodPublishingPoints': [{'name': 'testUpdate2',
                                           ...
                                           {'name': 'testUpdate1',
                                            'originId': 'originFTP'}]},
   'id': 'NO_PROXY_multipleConfPPT',
   'manifestRequestFrequency': 600,
   'maximumDownloadTime': 54000,
   'name': 'NO_PROXY_multipleConfPPT',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42728')
    @pytest.mark.Pathfinder_Edge_Device_Profiles
    @pytest.mark.POST
    def test_TC_42728_POST_Pathfinder_Edge_Device_Profiles_With_Multiple_Configurations_And_Ppt(self, context):
        """TC-42728 - Pathfinder_Edge_Device_Profiles-POST
           Verify that user is able to Create (mulitple configuratons & VOD PPT) VideoEdge device profile using POST /devices/veProfiles  ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to Create (mulitple configuratons & VOD PPT) VideoEdge device profile using POST /devices/veProfiles  ."""):
