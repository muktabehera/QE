...
* TC-42606 - Pathfinder_Edge_Device_Profiles DELETE:

  Verify that user isable to DELETE VideoEdge Profile in the application for DELETE request "/devices/veProfiles/{id}".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42606')
    @pytest.mark.Pathfinder_Edge_Device_Profiles
    @pytest.mark.DELETE
    def test_TC_42606_DELETE_Pathfinder_Edge_Device_Profiles_Able_To_Delete(self, context):
        """TC-42606 - Pathfinder_Edge_Device_Profiles-DELETE
           Verify that user isable to DELETE VideoEdge Profile in the application for DELETE request "/devices/veProfiles/{id}"."""
        # Define a test step
        with pytest.allure.step("""Verify that user isable to DELETE VideoEdge Profile in the application for DELETE request "/devices/veProfiles/{id}"."""):
