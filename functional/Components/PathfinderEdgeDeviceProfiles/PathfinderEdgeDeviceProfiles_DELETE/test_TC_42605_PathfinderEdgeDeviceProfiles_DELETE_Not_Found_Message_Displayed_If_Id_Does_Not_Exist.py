...
* TC-42605 - Pathfinder_Edge_Device_Profiles DELETE:

  Verify that user is getting "Not found" message if Profile id is not exists in the application for DELETE request "/devices/veProfiles/{id}".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-42605')
    @pytest.mark.Pathfinder_Edge_Device_Profiles
    @pytest.mark.DELETE
    def test_TC_42605_DELETE_Pathfinder_Edge_Device_Profiles_Not_Found_Message_Displayed_If_Id_Does_Not_Exist(self, context):
        """TC-42605 - Pathfinder_Edge_Device_Profiles-DELETE
           Verify that user is getting "Not found" message if Profile id is not exists in the application for DELETE request "/devices/veProfiles/{id}"."""
        # Define a test step
        with pytest.allure.step("""Verify that user is getting "Not found" message if Profile id is not exists in the application for DELETE request "/devices/veProfiles/{id}"."""):
