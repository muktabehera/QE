...
* TC-46673 - Diagnosis POST:

  Verify that 'clientEvaluations' is displayed with all the clients in response using request POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46673')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46673_POST_Diagnosis_Client_Evaluations(self, context):
        """TC-46673 - Diagnosis-POST
           Verify that 'clientEvaluations' is displayed with all the clients in response using request POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that 'clientEvaluations' is displayed with all the clients in response using request POST /diagnostices/requestId."""):
