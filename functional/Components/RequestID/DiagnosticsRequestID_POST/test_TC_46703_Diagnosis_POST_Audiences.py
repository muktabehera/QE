...
* TC-46703 - Diagnosis POST:

  Verify that all the 'audiences' are displayed in response using request POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46703')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46703_POST_Diagnosis_Audiences(self, context):
        """TC-46703 - Diagnosis-POST
           Verify that all the 'audiences' are displayed in response using request POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that all the 'audiences' are displayed in response using request POST /diagnostices/requestId."""):
