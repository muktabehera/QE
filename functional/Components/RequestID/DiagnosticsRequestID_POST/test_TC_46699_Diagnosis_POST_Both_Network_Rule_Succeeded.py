...
* TC-46699 - Diagnosis POST:

  Verify that network locations result is displayed as 'Succeeded' if both the groups result 'Succeeded' using request POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46699')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46699_POST_Diagnosis_Both_Network_Rule_Succeeded(self, context):
        """TC-46699 - Diagnosis-POST
           Verify that network locations result is displayed as 'Succeeded' if both the groups result 'Succeeded' using request POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that network locations result is displayed as 'Succeeded' if both the groups result 'Succeeded' using request POST /diagnostices/requestId."""):
