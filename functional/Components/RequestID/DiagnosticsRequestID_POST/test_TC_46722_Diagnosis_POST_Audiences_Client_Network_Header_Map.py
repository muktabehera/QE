...
* TC-46722 - Diagnosis POST:

  Verify that value in 'headerMap' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46722')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46722_POST_Diagnosis_Audiences_Client_Network_Header_Map(self, context):
        """TC-46722 - Diagnosis-POST
           Verify that value in 'headerMap' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that value in 'headerMap' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId."""):
