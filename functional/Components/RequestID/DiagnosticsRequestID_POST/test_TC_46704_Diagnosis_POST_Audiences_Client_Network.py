...
* TC-46704 - Diagnosis POST:

  Verify that 'clients' and 'NetworkLocations' associated with audience is displayed in response using request POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46704')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46704_POST_Diagnosis_Audiences_Client_Network(self, context):
        """TC-46704 - Diagnosis-POST
           Verify that 'clients' and 'NetworkLocations' associated with audience is displayed in response using request POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that 'clients' and 'NetworkLocations' associated with audience is displayed in response using request POST /diagnostices/requestId."""):
