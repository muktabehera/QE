...
* TC-46714 - Diagnosis POST:

  Verify that audience result is displayed as 'Succeeded' if 'clients' and 'networkLocations' result 'Succeeded' using request POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46714')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46714_POST_Diagnosis_Audiences_Both_Client_Network_Succeeded(self, context):
        """TC-46714 - Diagnosis-POST
           Verify that audience result is displayed as 'Succeeded' if 'clients' and 'networkLocations' result 'Succeeded' using request POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that audience result is displayed as 'Succeeded' if 'clients' and 'networkLocations' result 'Succeeded' using request POST /diagnostices/requestId."""):
