...
* TC-46717 - Diagnosis POST:

  Verify that value in 'remoteAddress' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46717')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46717_POST_Diagnosis_Audiences_Client_Network_Remote_Address(self, context):
        """TC-46717 - Diagnosis-POST
           Verify that value in 'remoteAddress' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that value in 'remoteAddress' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId."""):
