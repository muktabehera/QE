...
* TC-46716 - Diagnosis POST:

  Verify that audience result is displayed as 'Failed' if both of 'clients' and 'networkLocations' result 'Failed' using request POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46716')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46716_POST_Diagnosis_Audiences_Both_Client_Network_Failed(self, context):
        """TC-46716 - Diagnosis-POST
           Verify that audience result is displayed as 'Failed' if both of 'clients' and 'networkLocations' result 'Failed' using request POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that audience result is displayed as 'Failed' if both of 'clients' and 'networkLocations' result 'Failed' using request POST /diagnostices/requestId."""):
