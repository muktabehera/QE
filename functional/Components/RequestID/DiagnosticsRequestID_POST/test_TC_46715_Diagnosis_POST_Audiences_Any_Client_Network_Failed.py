...
* TC-46715 - Diagnosis POST:

  Verify that audience result is displayed as 'Failed' if any 'clients' and 'networkLocations' result 'Failed' using request POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46715')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46715_POST_Diagnosis_Audiences_Any_Client_Network_Failed(self, context):
        """TC-46715 - Diagnosis-POST
           Verify that audience result is displayed as 'Failed' if any 'clients' and 'networkLocations' result 'Failed' using request POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that audience result is displayed as 'Failed' if any 'clients' and 'networkLocations' result 'Failed' using request POST /diagnostices/requestId."""):
