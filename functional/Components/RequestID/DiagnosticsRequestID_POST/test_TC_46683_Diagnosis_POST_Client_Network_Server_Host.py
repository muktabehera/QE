...
* TC-46683 - Diagnosis POST:

  Verify that value in 'serverHost' parameter is displayed as per the 'client' and 'network Locations using POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46683')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46683_POST_Diagnosis_Client_Network_Server_Host(self, context):
        """TC-46683 - Diagnosis-POST
           Verify that value in 'serverHost' parameter is displayed as per the 'client' and 'network Locations using POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that value in 'serverHost' parameter is displayed as per the 'client' and 'network Locations using POST /diagnostices/requestId."""):
