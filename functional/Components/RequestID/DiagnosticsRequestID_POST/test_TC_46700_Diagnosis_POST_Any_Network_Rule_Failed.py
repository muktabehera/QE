...
* TC-46700 - Diagnosis POST:

  Verify that network locations result is displayed as 'Failed' if any of group result 'Failed' using request POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46700')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46700_POST_Diagnosis_Any_Network_Rule_Failed(self, context):
        """TC-46700 - Diagnosis-POST
           Verify that network locations result is displayed as 'Failed' if any of group result 'Failed' using request POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that network locations result is displayed as 'Failed' if any of group result 'Failed' using request POST /diagnostices/requestId."""):
