...
* TC-46790 - Diagnosis POST:

  Verify that value in 'queryMap' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46790')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46790_POST_Diagnosis_Audiences_Client_Network_Query(self, context):
        """TC-46790 - Diagnosis-POST
           Verify that value in 'queryMap' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that value in 'queryMap' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId."""):
