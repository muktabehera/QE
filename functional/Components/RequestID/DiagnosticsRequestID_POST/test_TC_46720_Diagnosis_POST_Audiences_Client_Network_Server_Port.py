...
* TC-46720 - Diagnosis POST:

  Verify that value in 'serverPort' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46720')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46720_POST_Diagnosis_Audiences_Client_Network_Server_Port(self, context):
        """TC-46720 - Diagnosis-POST
           Verify that value in 'serverPort' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that value in 'serverPort' parameter is displayed as per the 'client' and 'networkLocations' in audience using POST /diagnostices/requestId."""):
