...
* TC-46709 - Diagnosis POST:

  Verify that client result is displayed as 'Succeeded' in audience if both the groups result 'Succeeded' using request POST  /diagnostices/requestId.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-46709')
    @pytest.mark.Diagnosis
    @pytest.mark.POST
    def test_TC_46709_POST_Diagnosis_Audiences_Both_Client_Group_Succeeded(self, context):
        """TC-46709 - Diagnosis-POST
           Verify that client result is displayed as 'Succeeded' in audience if both the groups result 'Succeeded' using request POST  /diagnostices/requestId."""
        # Define a test step
        with pytest.allure.step("""Verify that client result is displayed as 'Succeeded' in audience if both the groups result 'Succeeded' using request POST  /diagnostices/requestId."""):
