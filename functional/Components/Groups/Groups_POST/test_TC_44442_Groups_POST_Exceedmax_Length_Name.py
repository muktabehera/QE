...
* TC-44442 - Groups POST:

  Verify that user is unable to create group on providing length greater than 100 character in parameter 'Name' using request POST '/groups'.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44442')
    @pytest.mark.Groups
    @pytest.mark.POST
    def test_TC_44442_POST_Groups_Exceedmax_Length_Name(self, context):
        """TC-44442 - Groups-POST
           Verify that user is unable to create group on providing length greater than 100 character in parameter 'Name' using request POST '/groups'."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to create group on providing length greater than 100 character in parameter 'Name' using request POST '/groups'."""):
