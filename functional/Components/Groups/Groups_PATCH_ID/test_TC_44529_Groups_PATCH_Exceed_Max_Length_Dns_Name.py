...
* TC-44529 - Groups PATCH:

  Verify that user is unable to modify group on providing length greater than 100 character in parameter 'dnsName' using request PATCH '/groups'.
...
JSON data sent to PathFinder in this test:
  ...
  {'configAdminCanEdit': True,
   ...
   'name': 'Updated Group with DNS_Name Max length Exceed',
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44529')
    @pytest.mark.Groups
    @pytest.mark.PATCH
    def test_TC_44529_PATCH_Groups_Exceed_Max_Length_Dns_Name(self, context):
        """TC-44529 - Groups-PATCH
           Verify that user is unable to modify group on providing length greater than 100 character in parameter 'dnsName' using request PATCH '/groups'."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to modify group on providing length greater than 100 character in parameter 'dnsName' using request PATCH '/groups'."""):
