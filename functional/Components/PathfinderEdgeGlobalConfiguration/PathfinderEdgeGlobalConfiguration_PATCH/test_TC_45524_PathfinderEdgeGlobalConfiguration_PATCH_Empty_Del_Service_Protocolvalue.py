...
* TC-45524 - Pathfinder_Edge_Global_Configuration PATCH:

  Verify that validation message is displayed while removing mandatory field deliveryServiceProtocol for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-45524')
    @pytest.mark.Pathfinder_Edge_Global_Configuration
    @pytest.mark.PATCH
    def test_TC_45524_PATCH_Pathfinder_Edge_Global_Configuration_Empty_Del_Service_Protocolvalue(self, context):
        """TC-45524 - Pathfinder_Edge_Global_Configuration-PATCH
           Verify that validation message is displayed while removing mandatory field deliveryServiceProtocol for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig ."""
        # Define a test step
        with pytest.allure.step("""Verify that validation message is displayed while removing mandatory field deliveryServiceProtocol for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig ."""):
