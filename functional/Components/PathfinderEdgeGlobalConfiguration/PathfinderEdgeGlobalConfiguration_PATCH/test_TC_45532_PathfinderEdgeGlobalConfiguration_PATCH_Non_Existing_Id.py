...
* TC-45532 - Pathfinder_Edge_Global_Configuration PATCH:

  Verify that validation message is displayed on providing non-existing 'ID' using request PATCH "/devices/veGlobalConfig".
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-45532')
    @pytest.mark.Pathfinder_Edge_Global_Configuration
    @pytest.mark.PATCH
    def test_TC_45532_PATCH_Pathfinder_Edge_Global_Configuration_Non_Existing_Id(self, context):
        """TC-45532 - Pathfinder_Edge_Global_Configuration-PATCH
           Verify that validation message is displayed on providing non-existing 'ID' using request PATCH "/devices/veGlobalConfig"."""
        # Define a test step
        with pytest.allure.step("""Verify that validation message is displayed on providing non-existing 'ID' using request PATCH "/devices/veGlobalConfig"."""):
