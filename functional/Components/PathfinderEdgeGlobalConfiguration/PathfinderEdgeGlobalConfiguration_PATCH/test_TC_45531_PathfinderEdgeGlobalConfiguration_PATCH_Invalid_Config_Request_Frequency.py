...
* TC-45531 - Pathfinder_Edge_Global_Configuration PATCH:

  Verify that validation message is displayed while providing invalid value for field configRequestFrequency for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig .
...
JSON data sent to PathFinder in this test:

  {
    ...
    "deliveryServicePort": 85080,
    "configRequestFrequency": invalid
  }
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-45531')
    @pytest.mark.Pathfinder_Edge_Global_Configuration
    @pytest.mark.PATCH
    def test_TC_45531_PATCH_Pathfinder_Edge_Global_Configuration_Invalid_Config_Request_Frequency(self, context):
        """TC-45531 - Pathfinder_Edge_Global_Configuration-PATCH
           Verify that validation message is displayed while providing invalid value for field configRequestFrequency for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig ."""
        # Define a test step
        with pytest.allure.step("""Verify that validation message is displayed while providing invalid value for field configRequestFrequency for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig ."""):
