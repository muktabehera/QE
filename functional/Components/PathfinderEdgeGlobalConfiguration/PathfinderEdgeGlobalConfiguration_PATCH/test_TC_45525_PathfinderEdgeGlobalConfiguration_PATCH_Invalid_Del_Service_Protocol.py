...
* TC-45525 - Pathfinder_Edge_Global_Configuration PATCH:

  Verify that validation message is displayed while providing invalid value for field deliveryServiceProtocol for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig .
...
JSON data sent to PathFinder in this test:
  ...
  {'configRequestFrequency': 700,
   ...
   'deliveryServiceProtocol': 'invalid'}
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-45525')
    @pytest.mark.Pathfinder_Edge_Global_Configuration
    @pytest.mark.PATCH
    def test_TC_45525_PATCH_Pathfinder_Edge_Global_Configuration_Invalid_Del_Service_Protocol(self, context):
        """TC-45525 - Pathfinder_Edge_Global_Configuration-PATCH
           Verify that validation message is displayed while providing invalid value for field deliveryServiceProtocol for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig ."""
        # Define a test step
        with pytest.allure.step("""Verify that validation message is displayed while providing invalid value for field deliveryServiceProtocol for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig ."""):
