...
* TC-45522 - Pathfinder_Edge_Global_Configuration PATCH:

  Verify that user is unable to update and validation message is displayed while removing mandatory field deliveryServiceHost  for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-45522')
    @pytest.mark.Pathfinder_Edge_Global_Configuration
    @pytest.mark.PATCH
    def test_TC_45522_PATCH_Pathfinder_Edge_Global_Configuration_Empty_Del_Service_Host(self, context):
        """TC-45522 - Pathfinder_Edge_Global_Configuration-PATCH
           Verify that user is unable to update and validation message is displayed while removing mandatory field deliveryServiceHost  for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is unable to update and validation message is displayed while removing mandatory field deliveryServiceHost  for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig ."""):
