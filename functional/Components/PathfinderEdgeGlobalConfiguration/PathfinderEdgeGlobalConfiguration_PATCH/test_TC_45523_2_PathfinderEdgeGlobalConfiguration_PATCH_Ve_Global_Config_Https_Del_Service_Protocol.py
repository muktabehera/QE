...
* TC-45523 - Pathfinder_Edge_Global_Configuration PATCH:

  Verify that user is able to update deliveryServiceProtocol on providing value 'http' or 'https' for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig .
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-45523')
    @pytest.mark.Pathfinder_Edge_Global_Configuration
    @pytest.mark.PATCH
    def test_TC_45523_PATCH_Pathfinder_Edge_Global_Configuration_Ve_Global_Config_Https_Del_Service_Protocol(self, context):
        """TC-45523 - Pathfinder_Edge_Global_Configuration-PATCH
           Verify that user is able to update deliveryServiceProtocol on providing value 'http' or 'https' for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig ."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to update deliveryServiceProtocol on providing value 'http' or 'https' for VideoEdge Global configuration using request PATCH /devices/veGlobalConfig ."""):
