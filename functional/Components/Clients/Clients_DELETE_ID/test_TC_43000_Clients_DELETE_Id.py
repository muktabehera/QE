...
* TC-43000 - Clients DELETE:

  Verify that user is able to delete the client using request DELETE /clients{id} with 'id' parameter.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43000')
    @pytest.mark.Clients
    @pytest.mark.DELETE
    def test_TC_43000_DELETE_Clients_Id(self, context):
        """TC-43000 - Clients-DELETE
           Verify that user is able to delete the client using request DELETE /clients{id} with 'id' parameter."""

        # Define a test step
        with pytest.allure.step("""CREATE: First create a Client using POST"""):
        ...
        # Define a test step
        with pytest.allure.step("""DELETE: Now verify that user is able to delete the client using request DELETE /clients{id} with 'id' parameter."""):
