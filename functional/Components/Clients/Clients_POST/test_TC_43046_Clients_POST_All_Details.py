...
* TC-43046 - Clients POST:

  Verify that user is able to create Client with parameters (id, Name, Rules, Groups, SourceSelectionRule ) using request POST /Clients.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43046')
    @pytest.mark.Clients
    @pytest.mark.POST
    def test_TC_43046_POST_Clients_All_Details(self, context):
        """TC-43046 - Clients-POST
           Verify that user is able to create Client with parameters (id, Name, Rules, Groups, SourceSelectionRule ) using request POST /Clients."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to create Client with parameters (id, Name, Rules, Groups, SourceSelectionRule ) using request POST /Clients."""):
