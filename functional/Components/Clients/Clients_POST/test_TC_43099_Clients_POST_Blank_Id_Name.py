...
* TC-43099 - Clients POST:

  Verify that correct message is displayed in response on providing Blank value in parameters 'Name' and 'Id' using request POST /Clients.
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-43099')
    @pytest.mark.Clients
    @pytest.mark.POST
    def test_TC_43099_POST_Clients_Blank_Id_Name(self, context):
        """TC-43099 - Clients-POST
           Verify that correct message is displayed in response on providing Blank value in parameters 'Name' and 'Id' using request POST /Clients."""
        # Define a test step


        with pytest.allure.step("""Verify that correct message is displayed in response on providing Blank value in parameters 'Name' and 'Id' using request POST /Clients."""):
