...
* TC-44412 - Pathfinder_Edge_Device_Upgrades POST:

  Verify that user is able to get the details of Video Edge Device Upgrade assigned devices using request POST  "/devices/upgrades/{upgradeId}/assignedDevice".
...
Equivalent test CURL command:
  ...
  curl -H "Host: <client_host>" -H "Authorization: Bearer <valid_token>"
       ...
       "<PF_host>://<client_host>/devices/upgrades/1233eda3-767d-4482-8948-9a412fef864e/assignedDevices?effectiveDate=1503656870000"
...
class Test_PFE_Components(object):
    ...
    @pytest.allure.link('https://jira.qumu.com/browse/TC-44412')
    @pytest.mark.Pathfinder_Edge_Device_Upgrades
    @pytest.mark.POST
    def test_TC_44412_POST_Pathfinder_Edge_Device_Upgrades_Assigned_Devices(self, context):
        """TC-44412 - Pathfinder_Edge_Device_Upgrades-POST
           Verify that user is able to get the details of Video Edge Device Upgrade assigned devices using request POST  "/devices/upgrades/{upgradeId}/assignedDevice"."""
        # Define a test step
        with pytest.allure.step("""Verify that user is able to get the details of Video Edge Device Upgrade assigned devices using request POST  "/devices/upgrades/{upgradeId}/assignedDevice"."""):
